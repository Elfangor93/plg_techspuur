 ...
 *
 *        ./vendor/bin/php-cs-fixer fix --dry-run plugin/src/Extension/TechSpuur.php
 *        ./vendor/bin/php-cs-fixer fix plugin/src/Extension/TechSpuur.php
 */
